    ...
    <article className="rounded-2xl max-w-3xl overflow-hidden shadow-lg" >
      ...
      <div className="relative" >
        ...
        <div className="absolute right-2 bottom-2 p-1 bg-rosePrimary rounded-full" >
          <Image src={game?.image} alt={game?.name} className="w-20 h-20 rounded-full object-cover" />
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 md:gap-5 p-3 md:p-5 bg-[#2B0C52]" >
        ...
        <div className="flex flex-col gap-1 w-full" >
          ...
          <div className="flex justify-between items-center text-sm md:text-base pt-2 text-white/60" >
            {torneo.payment ?
